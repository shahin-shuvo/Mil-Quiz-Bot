...
class JCOQues extends StatefulWidget {
  const JCOQues({super.key});

  @override
  State<JCOQues> createState() => _JCOQuesState();
}

class _JCOQuesState extends State<JCOQues> {
  ...
  void _loadCSV()  async {
    final _rawData =  await rootBundle.loadString("assets/data/jco_ques.csv");
